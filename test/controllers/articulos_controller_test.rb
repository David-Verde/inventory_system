...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference("Articulo.count") do
      post articulos_url, params: { articulo: { fecha_ingreso: @articulo.fecha_ingreso, modelo_id: @articulo.modelo_id, persona_id: @articulo.persona_id } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { fecha_ingreso: @articulo.fecha_ingreso, modelo_id: @articulo.modelo_id, persona_id: @articulo.persona_id } }
